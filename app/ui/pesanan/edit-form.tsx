...
import { PelangganField, ProdukField, PesananForm } from '@/app/lib/definitions';
import {
  CheckIcon,
  ClockIcon,
  CurrencyDollarIcon,
...
import { updatePesanan } from '@/app/lib/actions';

export default function EditPesananForm({
  pesanan,
  pelanggan,
  products,
}: {
  ...
  products: ProdukField[];
}) {
  const updatePesananWithId = updatePesanan.bind(null, pesanan.id);
  return (
    <form action={updatePesananWithId} method="post" className="max-w-lg mx-auto bg-gray-900 p-6 rounded-lg shadow-lg">
      <h2 className="text-xl font-semibold text-white mb-4">Edit Pesanan</h2>
      <div className="rounded-md bg-gray-800 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue={pesanan.pelanggan_id}
            >
        ...
        {/* Produk */}
        <div className="mb-4">
          <label htmlFor="product" className="mb-2 block text-sm font-medium text-white">
            Pilih Produk
          </label>
          <div className="relative">
            <select
              ...
              name="productId"
              className="peer block w-full cursor-pointer rounded-md border border-gray-700 bg-gray-800 py-2 pl-10 text-sm text-white placeholder:text-gray-500 focus:border-violet-500 focus:ring-violet-500"
              defaultValue={pesanan.product_id}
            >
              <option value="" disabled>
                Pilih produk
              </option>
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                type="number"
                step="0.01"
                defaultValue={pesanan.total_harga}
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  defaultChecked={pesanan.status_pesanan === 'pending'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="completed"
                  defaultChecked={pesanan.status_pesanan === 'completed'}
                  className="h-4 w-4 cursor-pointer border-gray-600 bg-gray-800 text-gray-600 focus:ring-violet-500"
                />
                <label
                  htmlFor="completed"
